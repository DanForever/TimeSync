...
var subscribe_config =
{
	"request" :
	{
		url: defines.Domain + "v1/tvshowtime/agenda/subscribe/",
		type: 'json',
		method: 'post',
		headers : {},
	},
...
var unsubscribe_config =
{
	"request" :
	{
		url: defines.Domain + "v1/tvshowtime/agenda/unsubscribe/",
		type: 'json',
		method: 'post',
		headers : {},
	},
...
var check_subscription_config =
{
	"request" :
	{
		url: defines.Domain + "v1/tvshowtime/agenda/issubscribed/",
		type: 'json',
		method: 'post',
		headers : {},
	},
